...
class PropertySeeder extends Seeder
{
    public function run(): void
    {
        ...
        Property::create([
            ...
            'payment_options' => json_encode(['cash']),
            'cover_image' => 'properties/alex1.jpg',
        ...
        Property::create([
            ...
            'amenities' => json_encode(['balcony', 'security']),
            'payment_options' => json_encode(['cash', 'installments']),
            'cover_image' => 'properties/alex2.jpg',
        ...
        Property::create([
            ...
            'cover_image' => 'properties/alex3.jpg',
        ...
        Property::create([
            ...
            'payment_options' => json_encode(['cash', 'installments']),
            'cover_image' => 'properties/alex4.jpg',
        ...
        Property::create([
            ...
            'legal_status' => 'licensed',
            'payment_options' => json_encode(['cash']),
            'cover_image' => 'properties/alex5.jpg',
        ...
        Property::create([
            ...
            'payment_options' => json_encode(['cash']),
            'cover_image' => 'properties/alex6.jpg',
        ...
        Property::create([
            ...
            'payment_options' => json_encode(['bank_transfer']),
            'cover_image' => 'properties/alex7.jpg',
        ...
        Property::create([
            ...
            'payment_options' => json_encode(['bank_transfer']),
            'cover_image' => 'properties/alex8.jpg',
        ...
        Property::create([
            ...
            'payment_options' => json_encode(['cash', 'installments']),
            'cover_image' => 'properties/alex9.jpg',
        ...
        Property::create([
            ...
            'payment_options' => json_encode(['cash']),
            'cover_image' => 'properties/alex10.jpg',
        ...
        Property::create([
            ...
            'payment_options' => json_encode(['cash']),
            'cover_image' => 'properties/alex11.jpg',
        ...
        Property::create([
            ...
            'payment_options' => json_encode(['cash']),
            'cover_image' => 'properties/alex13.jpg',
            'property_code' => 'ALX013',
            'user_id' => 4,
        ]);

        Property::create([
            'title' => 'Historic Home with Renovation Potential',
            'slug' => 'historic-home-bulkeley',
            'description' => '300m² historic property needing complete renovation, great investment opportunity.',
            'type' => 'villa',
            'price' => 4500000.00,
            'commission' => 4500000.00 * 0.05,
            'city' => 'Alexandria',
            'district' => 'Bulkeley',
            'full_address' => '3 Bulkeley Gardens',
            'area' => 300,
            'bedrooms' => 4,
            'bathrooms' => 3,
            'listing_type' => 'for_sale',
            ...
            'amenities' => json_encode(['garden', 'historic']),
            'payment_options' => json_encode(['cash']),
            'cover_image' => 'properties/alex15.jpg',
            'property_code' => 'ALX015',
            'user_id' => 1,
        ]);
    }
}
